...
public class Mover34 extends Mover {
	...
	public void run() {
		while (true) {
			try {
				...
				((Room) mobile.getLocation()).sendToRoom("You feel a powerful energy around the portal...");
				((Room) mobile.getLocation()).movePlayerTo(35);
