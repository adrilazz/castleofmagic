...
public class Player extends DatabaseObject implements Movable {
	...
	public Player(String name) {
		...
		weaponEquipped = new Weapon("Bare Hands",
				"You should not need anything else", 2, 7);
	...
	public void moveToRoom(Room destination) {
		...
		client.sendReply("cambio " + roomId);
		String s = ((Room) this.getLocation()).generateDescription();
		if (s != "null" && s != "") {
			sendToPlayer(s);
		}
	}
